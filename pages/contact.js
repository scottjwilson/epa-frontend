...
export default function ContactPage() {
  return (
    <Layout title="Contact">
      <Animated>
        <Hero title="Let's start making your perfect website" />
        <Section>
          <div className="p-2">
            <p className="text-center">
              ...
              needs. Business and techonology are always evolving, you'll need
              innovative solutions to stay ahead of the curve. Your website
